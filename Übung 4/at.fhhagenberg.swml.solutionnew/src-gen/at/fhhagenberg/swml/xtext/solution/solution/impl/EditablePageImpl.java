 ...
 * </p>
 * <ul>
 *   <li>{@link at.fhhagenberg.swml.xtext.solution.solution.impl.EditablePageImpl#getBack <em>Back</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EditablePageImpl extends DynamicPageImpl implements EditablePage
{
  /**
  ...
  public NotificationChain basicSetBack(ContextualLink newBack, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SolutionPackage.EDITABLE_PAGE__BACK, oldBack, newBack);
  ...
  public void setBack(ContextualLink newBack)
  {
    if (newBack != back)
    {
      ...
      if (back != null)
        msgs = ((InternalEObject)back).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SolutionPackage.EDITABLE_PAGE__BACK, null, msgs);
      if (newBack != null)
        msgs = ((InternalEObject)newBack).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SolutionPackage.EDITABLE_PAGE__BACK, null, msgs);
      msgs = basicSetBack(newBack, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SolutionPackage.EDITABLE_PAGE__BACK, newBack, newBack));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SolutionPackage.EDITABLE_PAGE__BACK:
