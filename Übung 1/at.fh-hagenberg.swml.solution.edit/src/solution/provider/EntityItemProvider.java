...
/**
 * This is the item provider adapter for a {@link solution.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.ENTITY__ID,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SolutionPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(SolutionPackage.Literals.ENTITY__RELATIONSHIPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			case SolutionPackage.ENTITY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SolutionPackage.ENTITY__ATTRIBUTES:
			case SolutionPackage.ENTITY__RELATIONSHIPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SolutionPackage.Literals.ENTITY__ATTRIBUTES,
				 SolutionFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(SolutionPackage.Literals.ENTITY__RELATIONSHIPS,
				 SolutionFactory.eINSTANCE.createRelationship()));
	}
