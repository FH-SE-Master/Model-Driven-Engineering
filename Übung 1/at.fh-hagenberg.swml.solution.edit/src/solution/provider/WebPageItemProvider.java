...
/**
 * This is the item provider adapter for a {@link solution.WebPage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WebPageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.WEB_PAGE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRelativeUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WebPage_relativeUrl_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WebPage_relativeUrl_feature", "_UI_WebPage_type"),
				 SolutionPackage.Literals.WEB_PAGE__RELATIVE_URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SolutionPackage.Literals.WEB_PAGE__LINKS);
			childrenFeatures.add(SolutionPackage.Literals.WEB_PAGE__HOME_LINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SolutionPackage.Literals.WEB_PAGE__LINKS,
				 SolutionFactory.eINSTANCE.createNonContextualLink()));

		newChildDescriptors.add
			(createChildParameter
				(SolutionPackage.Literals.WEB_PAGE__LINKS,
				 SolutionFactory.eINSTANCE.createContextualLink()));

		newChildDescriptors.add
			(createChildParameter
				(SolutionPackage.Literals.WEB_PAGE__HOME_LINK,
				 SolutionFactory.eINSTANCE.createNonContextualLink()));
	}
