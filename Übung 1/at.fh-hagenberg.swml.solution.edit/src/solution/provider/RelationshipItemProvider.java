...
/**
 * This is the item provider adapter for a {@link solution.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.RELATIONSHIP__OPPOSITE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRoleNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_roleName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_roleName_feature", "_UI_Relationship_type"),
				 SolutionPackage.Literals.RELATIONSHIP__ROLE_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.RELATIONSHIP__LOWER_BOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SolutionPackage.Literals.RELATIONSHIP__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Relationship)object).getRoleName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Relationship.class)) {
			case SolutionPackage.RELATIONSHIP__ROLE_NAME:
			case SolutionPackage.RELATIONSHIP__LOWER_BOUND:
			case SolutionPackage.RELATIONSHIP__UPPER_BOUND:
